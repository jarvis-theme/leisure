            ...
            @elseif($setting->checkoutType==3)
                ...
                @foreach ($order as $item)
                    <tr>
                        ...
                        @if($item->status<4)
                        <td class="align_center vline"><a href="{{URL::to('konfirmasipreorder/'.$item->id)}}" class="sc-button small blue" target="_self"> Konfirmasi Pembayaran </a></td>
                        @endif
                    </tr>
                @endforeach
              </table>
            ...
            <div class="simpleTabsContent">
                <div id="checkout-step-login">
                    {{Form::open(array('url'=>'member/update','method'=>'put','class'=>'form-horizontal'))}}
                        ...
                        <button  class="button brown_btn" type="submit">Update</button>
                        <br/>
                    </form>
                </div>
            </div>
